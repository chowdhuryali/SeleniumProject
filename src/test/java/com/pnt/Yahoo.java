...
public class Yahoo {
    ...
    public void test1() throws InterruptedException {
        ...
        Assert.assertEquals("Success!!", "Yahoo | Mail, Weather, Search, Politics, News, Finance, Sports & Videos", title);
    }
    @Test
    ...
    public void test3() throws InterruptedException {
        driver.findElement(By.id("ybar-sbq")).sendKeys("learn selenium");
